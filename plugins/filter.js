...
if (plkser.message !== false && plkser.message.includes('{bgm}')) {
        ...
        if (!!message.mention && message.mention[0] == '299556666@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/bgmone/maddy.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
